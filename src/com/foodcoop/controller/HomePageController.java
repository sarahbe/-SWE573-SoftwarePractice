...
public class HomePageController {
	...
	// The @RequestMapping annotation on the methods use the value attribute to
	// map the method to a path.
	...
	public ModelAndView SuccessfullRegister() {

		return new ModelAndView("SuccessfullRegister");
	}
